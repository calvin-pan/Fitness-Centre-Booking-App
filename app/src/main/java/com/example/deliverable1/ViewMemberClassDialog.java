...
public class ViewMemberClassDialog extends AppCompatDialogFragment {
    ...
    private ViewMemberDialogListener listener;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setView(view).setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            .setNegativeButton("Enroll", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    listener.enroll();
                }
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (ViewMemberDialogListener) context;
        }
        catch (ClassCastException e) {
            throw new ClassCastException(context.toString() + " must implement ViewMemberDialogListener");
        }
    }
    ...
    public interface  ViewMemberDialogListener {
        long enroll();
    }
